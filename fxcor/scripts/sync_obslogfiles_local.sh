...
echo "Please provide the password for the USM machine (ltsp01):"
rsync -av fahrenschon@ltsp01.usm.uni-muenchen.de:/home/moon/fahrenschon/copy_logs/obslog/ /mnt/e/logfiles/observations
...
echo "Please provide the password for the USM machine (ltsp01):"
rsync -av fahrenschon@ltsp01.usm.uni-muenchen.de:/home/moon/fahrenschon/temp_frames/ /mnt/e/FOCES_data
