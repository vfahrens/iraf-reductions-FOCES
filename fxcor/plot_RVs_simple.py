...
plt.errorbar(x2, RVs_fl2, yerr=RVerr_fl2, fmt='o', label='51Peg_old', alpha=0.5)
plt.errorbar(x3, RVs_fl3, yerr=RVerr_fl3, fmt='o', label='51Peg_new', alpha=0.5)
plt.plot(x2, RVerr_fl3 - RVerr_fl2, 'o', label='51Peg_err_diff', alpha=0.5)
...
plt.errorbar(dates_fl2, RVs_fl2, yerr=RVerr_fl2, fmt='o', label='51Peg_old', alpha=0.5)
plt.errorbar(dates_fl3, RVs_fl3, yerr=RVerr_fl3, fmt='o', label='51Peg_new', alpha=0.5)
# plt.hlines(rv_weightmean, [0], len(x), lw=2)
